...
const DIMENSION_LABEL_PIXELS = 40;
const DIMENSION_OUTER_LABEL_PIXELS = 40;
...
const DIMENSION_SEGMENT_SIDE_GAP = 96 * DIMENSION_MM;
const DIMENSION_DEPTH_LANE_GAP = 120 * DIMENSION_MM;
const DIMENSION_DEPTH_LANE_STEP = 96 * DIMENSION_MM;
const DIMENSION_OUTER_WIDTH_FRONT_GAP = 118 * DIMENSION_MM;
const DIMENSION_OUTER_HEIGHT_SIDE_GAP = 264 * DIMENSION_MM;
const DIMENSION_OUTER_DEPTH_EXTRA_GAP = 96 * DIMENSION_MM;
