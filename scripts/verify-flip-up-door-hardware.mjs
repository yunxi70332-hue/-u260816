...
const outputDir = path.resolve("artifacts/flip-up-door-verification");

function flipUpDoorConfig(doorOpen, doorState) {
  const cell = {
...
for (const [name, doorOpen, doorState] of states) {
  await installConfig(page, flipUpDoorConfig(doorOpen, doorState));
